...
#配置文件名称
CONF_FILE=exactor.properties

echo "now use config filename is : $CONF_FILE"

#程序运行主类
SERVER_MAIN=com.kanven.schedual.ExactorBootstrap
...
#java 常规启动
JAVA_OPTS=" -Djava.awt.headless=true -Djava.net.preferIPv4Stack=true -Denv=$ENV -DLogPath=$LOGS_DIR"
#debug启动,端口号默认使用8000
